...
from relevanceSimilarity.src.models.model_utils import kernel_mu
from relevanceSimilarity.src.models.model_utils import kernel_sigma
...
class KNRM(nn.Module):
    ...
    def __init__(self, config, weights):
        ...
        self.config = config
        self.embed_layer = nn.Embedding(len(self.weights.w2v.index2word), self.weights.vector_size, padding_idx=0)  # 加载预训练的向量
        self.embed_layer.weight.requires_grad = False   # 禁止求导
